...
#obj-$(CONFIG_MT7601) += mt7601usta.o
obj-m +=mt7601usta.o
obj-m +=mtprealloc.o
#add prealloc
...
#EXTRA_CFLAGS += -DANDROID_SUPPORT -DCONFIG_LITTLE_ENDIAN -DUSB_BULK_BUF_PREALLOC -DUSB_BULK_BUF_ALIGMENT
...
EXTRA_CFLAGS += -DANDROID_SUPPORT -DPBF_MONITOR_SUPPORT -DCONFIG_LITTLE_ENDIAN -DUSB_BULK_BUF_ALIGMENT -DUSB_BULK_BUF_PREALLOC
...
# config for STA mode
#	$(CROSS_COMPILE)strip --strip-debug $(RT28xx_DIR)/mt7601usta.ko
...
#aarch64-linux-gnu-strip --strip-debug mt7601usta.ko
