...
#RT28xx_DIR = /mnt/nfsroot/rongjun.chen/n-amlogic/hardware/wifi/mtk/drivers/mt7601
...
#PLATFORM = MSTAR
PLATFORM = HISILICON
LINUX_SRC ?= /mnt/nfsroot/rongjun.chen/n-amlogic/out/target/product/txlx_t962x_r311/obj/KERNEL_OBJ
...
LINUX_SRC=$(RT28xx_DIR)/../../../../../output/mtk_android/mt5860_cn_android_JB/rel/obj/kernel/chiling/kernel/linux-3.4/mt5880_android_smp_mod_defconfig_modules
#LINUX_SRC=$(RT28xx_DIR)/../../../../../output/mtk_android/mt5860_cn_android_JB/debug/obj/kernel/chiling/kernel/linux-3.4/mt5880_android_smp_mod_dbg_defconfig_modules
ifeq ($(CROSS_COMPILE),)
...
#ARCH=arm
LINUX_SRC =/home/ralink/MID_NEW/4.2-V10-A13/lichee/linux-3.0
CROSS_COMPILE=/home/ralink/MID_NEW/4.2-V10-A13/lichee/buildroot/output/external-toolchain/bin/arm-none-linux-gnueabi-
#CROSS_COMPILE = /opt/android4.0/android4.0/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-
endif

ifeq ($(PLATFORM),PANDA)
LINUX_SRC = /home/ralink/Panda_backup/kernel
CROSS_COMPILE = /home/ralink/Panda/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-
endif
...
#build mt7601usta.ko
	...
	$(CROSS_COMPILE)strip --strip-debug $(RT28xx_DIR)/os/linux/mt7601usta.ko
endif
endif
...
ifeq ($(PLATFORM),MT53XX)
	cp -f $(RT28xx_DIR)/os/linux/mt$(MODULE)ap.ko ../../../../../android/jb-4.x/device/mtk/mt5396/prebuilt/wifi/
else
