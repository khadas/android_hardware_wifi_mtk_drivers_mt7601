...
#define SINGLE_OPN_AP_MODE(__pAd)                       (IS_OPMODE_AP(__pAd) || RTMP_CFG80211_VIF_P2P_GO_ON(__pAd))
#define SINGLE_OPN_STA_MODE(__pAd)                      (INFRA_ON(__pAd) || RTMP_CFG80211_VIF_P2P_CLI_ON(__pAd))
#define CONCURNT_MULTI_STA_CASE(__pAd)                  (INFRA_ON(__pAd) && RTMP_CFG80211_VIF_P2P_CLI_ON(__pAd))
#else
#define SINGLE_OPN_AP_MODE(__pAd)				(IS_OPMODE_AP(__pAd) || P2P_GO_ON(__pAd))
#define SINGLE_OPN_STA_MODE(__pAd)			(INFRA_ON(__pAd) || P2P_CLI_ON(__pAd))
#define CONCURNT_MULTI_STA_CASE(__pAd)		(INFRA_ON(__pAd) && P2P_CLI_ON(__pAd))
