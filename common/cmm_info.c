	...
	IN	PSTRING			arg)
{
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw20RssiThr0 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_20 Rssi Thr0=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw20RssiThr0));
	return TRUE;
}


INT Set_BW20_RSSI_THR1_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw20RssiThr1 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_20 Rssi Thr1=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw20RssiThr1));
	return TRUE;
}

INT Set_BW20_RSSI_THR2_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw20RssiThr2 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_20 Rssi Thr2=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw20RssiThr2));
	return TRUE;
}

INT Set_BW20_RSSI_THR3_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw20RssiThr3 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_20 Rssi Thr3=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw20RssiThr3));
	return TRUE;
}

INT Set_BW40_RSSI_THR0_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw40RssiThr0 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_40 Rssi Thr0=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw40RssiThr0));
	return TRUE;
}


INT Set_BW40_RSSI_THR1_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw40RssiThr1 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_40 Rssi Thr1=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw40RssiThr1));
	return TRUE;
}

INT Set_BW40_RSSI_THR2_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw40RssiThr2 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_40 Rssi Thr2=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw40RssiThr2));
	return TRUE;
}

INT Set_BW40_RSSI_THR3_Proc(
	IN	PRTMP_ADAPTER	pAd, 
	IN	PSTRING			arg)
{
	INT16 Value;
	...
	Value = (UINT16)simple_strtol(arg, 0, 10);
	pAd->CommonCfg.Bw40RssiThr3 = Value;
	DBGPRINT(RT_DEBUG_TRACE, ("IF %s::(BW_40 Rssi Thr3=%d)\n", __FUNCTION__, pAd->CommonCfg.Bw40RssiThr3));
	return TRUE;
}
	...
	IN	PRTMP_ADAPTER	pAd)
{
	if (IS_MT7601(pAd))
	{
			...
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw20RssiThr0, -36);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw20RssiThr1, -50);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw20RssiThr2, -75);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw20RssiThr3, -80);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw40RssiThr0, -35);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw40RssiThr1, -49);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw40RssiThr2, -76);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.Bw40RssiThr3, -80);
			...
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.NoiseRssiThr3, -75);
	    		...
	    		/*FCCA thredshold*/
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.FccaThr1, 1800);
			SET_DEFAULT_THRESHOLD(pAd->CommonCfg.FccaThr2, 200);

			/*Register initial*/
			pAd->CommonCfg.InitR65 = 0x2C;
			pAd->CommonCfg.InitR66 = 0x14;
			#ifdef CE_BBP_NOISE_ENDURANCE_SUPPORT
	    		pAd->CommonCfg.InitR68 = 0xDD;
			#else
	    		pAd->CommonCfg.InitR68 = 0x8B;
			#endif
