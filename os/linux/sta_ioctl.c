...
/*	if(!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_INTERRUPT_IN_USE)) */
	...
	DBGPRINT(RT_DEBUG_INFO ,("===>rt_ioctl_giwrange\n"));
...
/*    if(!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_INTERRUPT_IN_USE)) */
	...
	{	
		...
		case SIOCDEVPRIVATE + 1:
			//Status = rt_android_private_command_entry(pAd, net_dev, rq, cmd);
			Status = RTMP_COM_IoctlHandle(pAd, wrq, CMD_RTPRIV_IOCTL_80211_ANDROID_PRIV_CMD,
						0, NULL, 0);
			break;
#endif /* RT_CFG80211_SUPPORT */
